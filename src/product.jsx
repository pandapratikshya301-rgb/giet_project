...
import auraHeadphones from './assets/aura_headphones.png';
import apexWatch from './assets/apex_watch.png';
import nebulaProjector from './assets/nebula_projector.png';
import shiftKeyboard from './assets/shift_keyboard.png';
import denimJacketMale from './assets/denim_jacket_male.png';
import windbreakerFemale from './assets/windbreaker_female.png';
import joggersKids from './assets/joggers_kids.png';
import toteFemale from './assets/tote_female.png';
import backpackKids from './assets/backpack_kids.png';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start mb-16">
          ...
          <div className="lg:col-span-2">
            {filteredProducts.length === 0 ? (
              <div className="py-20 text-center flex flex-col items-center justify-center bg-slate-900/10 border border-dashed border-slate-850 rounded-3xl">
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="absolute top-4 left-4 z-10 flex gap-1.5">
                        <span className="px-3 py-1 rounded-full text-[10px] font-semibold tracking-wider bg-slate-950/85 border border-slate-850 backdrop-blur-sm text-slate-300">
                          {product.type}
                        </span>
                      ...
                      {/* Image Frame */}
                      <div className="relative aspect-square overflow-hidden bg-slate-955/40 flex items-center justify-center p-6 border-b border-slate-900">
                        <img 
                          src={product.image} 
                          alt={product.name} 
        ...
        <section id="selection-dashboard" className="pt-8 border-t border-slate-900">
            ...
            {PRODUCTS.map((product) => {
              ...
              return (
                <div key={product.id} className="bg-slate-900/10 border border-slate-900 p-6 rounded-3xl flex flex-col gap-4 relative overflow-hidden group">
                  ...
                  {/* Progress bar */}
                  <div className="w-full bg-slate-850 h-2 rounded-full overflow-hidden z-10 mt-auto">
                    <div 
          ...
          <div className="mt-8 p-6 rounded-3xl bg-slate-900/20 border border-slate-900/60 flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <button 
              ...
              className="px-6 py-2.5 rounded-xl text-xs font-bold text-rose-400 hover:text-white bg-rose-950/20 hover:bg-rose-600 border border-rose-900/60 hover:border-rose-500 transition-all disabled:opacity-30 disabled:pointer-events-none cursor-pointer flex items-center gap-2"
            >
